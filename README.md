...
1. **Flash** the Python script onto your micro:bit V2 using the *Mu Editor* or the *Online Python Editor*.
2. **Disconnect** and place the device in your target location (ensure it stays powered via battery pack or USB).
3. **Retrieve** the `LOG.CSV` file from the micro:bit drive once recording is complete.
